<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Hedefe Git Uygulaması';
      if(isset($_SESSION['[ROBOTBASIC] Hedefe Git Uygulaması']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Hedefe Git Uygulaması']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--hedefe-git-uygulamasi.php'>
