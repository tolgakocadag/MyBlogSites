<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Robotun Hızını ve Şarjını Ayarlama';
      if(isset($_SESSION['[ROBOTBASIC] Robotun Hızını ve Şarjını Ayarlama']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Robotun Hızını ve Şarjını Ayarlama']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--robotun-hizini-ve-sarjini-ayarlama.php'>
