<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Bitmap Resmi Ekleme';
      if(isset($_SESSION['[ROBOTBASIC] Bitmap Resmi Ekleme']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Bitmap Resmi Ekleme']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--bitmap-resmi-ekleme.php'>
