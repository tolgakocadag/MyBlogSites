<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Fonksiyon Oluşturma';
      if(isset($_SESSION['[ROBOTBASIC] Fonksiyon Oluşturma']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Fonksiyon Oluşturma']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--fonksiyon-olusturma.php'>
