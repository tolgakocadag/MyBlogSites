<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='"header information - headers already sent by" Hatasının Çözümü';
      if(isset($_SESSION['"header information - headers already sent by" Hatasının Çözümü']))
      {
      }
      else{
      ...
      $_SESSION['"header information - headers already sent by" Hatasının Çözümü']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-header-information---headers-already-sent-by--hatasinin-cozumu.php'>
