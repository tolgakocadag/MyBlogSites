<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='PHP Mysqli Veri Tabanı Bağlantısı';
      if(isset($_SESSION['PHP Mysqli Veri Tabanı Bağlantısı']))
      {
      }
      else{
      ...
      $_SESSION['PHP Mysqli Veri Tabanı Bağlantısı']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='php-mysqli-veri-tabani-baglantisi.php'>
