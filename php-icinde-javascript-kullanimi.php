<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='PHP içinde JavaScript Kullanımı';
      if(isset($_SESSION['PHP içinde JavaScript Kullanımı']))
      {
      }
      else{
      ...
      $_SESSION['PHP içinde JavaScript Kullanımı']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='php-icinde-javascript-kullanimi.php'>
