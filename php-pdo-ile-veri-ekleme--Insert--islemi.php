  ...
  ?>
  <?php
      $title='PHP PDO ile veri ekleme (INSERT) işlemi';
      if(isset($_SESSION['PHP PDO ile veri ekleme (INSERT) işlemi']))
      {
      }
      else{
      ...
      $_SESSION['PHP PDO ile veri ekleme (INSERT) işlemi']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='php-pdo-ile-veri-ekleme--Insert--islemi.php'>
