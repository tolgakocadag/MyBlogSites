<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[PHP] Türkiye İl İlçe Listeleme ( Veritabanıyla Birlikte)';
      if(isset($_SESSION['[PHP] Türkiye İl İlçe Listeleme ( Veritabanıyla Birlikte)']))
      {
      }
      else{
      ...
      $_SESSION['[PHP] Türkiye İl İlçe Listeleme ( Veritabanıyla Birlikte)']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-php--turkiye-il-ilce-listeleme---veritabaniyla-birlikte.php'>
