<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='PHPMailer SMTP Mail Gönderimi';
      if(isset($_SESSION['PHPMailer SMTP Mail Gönderimi']))
      {
      }
      else{
      ...
      $_SESSION['PHPMailer SMTP Mail Gönderimi']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='phpmailer-smtp-mail-gonderimi.php'>
