<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[PHP] HTML kodlarını olduğu gibi yazdırmak';
      if(isset($_SESSION['[PHP] HTML kodlarını olduğu gibi yazdırmak']))
      {
      }
      else{
      ...
      $_SESSION['[PHP] HTML kodlarını olduğu gibi yazdırmak']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-php--html-kodlarini-oldugu-gibi-yazdirmak.php'>
