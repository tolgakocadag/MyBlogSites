<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='PHP multiexplode() kullanımı';
      if(isset($_SESSION['PHP multiexplode() kullanımı']))
      {
      }
      else{
      ...
      $_SESSION['PHP multiexplode() kullanımı']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='php-multiexplode---kullanimi.php'>
