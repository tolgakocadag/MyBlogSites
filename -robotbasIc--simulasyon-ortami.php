<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Simülasyon Ortamı';
      if(isset($_SESSION['[ROBOTBASIC] Simülasyon Ortamı']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Simülasyon Ortamı']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--simulasyon-ortami.php'>
