  ...
  ?>
  <?php
      $title='Robots.txt Nedir ve Nasıl Oluşturulur ?';
      if(isset($_SESSION['Robots.txt Nedir ve Nasıl Oluşturulur ?']))
      {
      }
      else{
      ...
      $_SESSION['Robots.txt Nedir ve Nasıl Oluşturulur ?']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='robots.txt-nedir-ve-nasil-olusturulur.php'>
