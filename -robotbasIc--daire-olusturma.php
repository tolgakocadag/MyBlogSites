<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Daire Oluşturma';
      if(isset($_SESSION['[ROBOTBASIC] Daire Oluşturma']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Daire Oluşturma']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--daire-olusturma.php'>
