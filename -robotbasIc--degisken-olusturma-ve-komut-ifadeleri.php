<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Değişken oluşturma ve Komut İfadeleri';
      if(isset($_SESSION['[ROBOTBASIC] Değişken oluşturma ve Komut İfadeleri']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Değişken oluşturma ve Komut İfadeleri']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--degisken-olusturma-ve-komut-ifadeleri.php'>
