<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Robotu ilerletme ve Robotun Açısını Değiştirme';
      if(isset($_SESSION['[ROBOTBASIC] Robotu ilerletme ve Robotun Açısını Değiştirme']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Robotu ilerletme ve Robotun Açısını Değiştirme']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--robotu-ilerletme-ve-robotun-acisini-degistirme.php'>
