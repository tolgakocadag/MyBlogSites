<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='Arduino Bilgisayarın Görmeme Sorunu';
      if(isset($_SESSION['Arduino Bilgisayarın Görmeme Sorunu']))
      {
      }
      else{
      ...
      $_SESSION['Arduino Bilgisayarın Görmeme Sorunu']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='arduino-bilgisayarin-gormeme-sorunu.php'>
