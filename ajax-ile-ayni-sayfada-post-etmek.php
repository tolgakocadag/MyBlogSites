<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='AJAX ile Aynı Sayfada POST etmek';
      if(isset($_SESSION['AJAX ile Aynı Sayfada POST etmek']))
      {
      }
      else{
      ...
      $_SESSION['AJAX ile Aynı Sayfada POST etmek']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='ajax-ile-ayni-sayfada-post-etmek.php'>
