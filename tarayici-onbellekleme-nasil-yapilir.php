<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='Tarayıcı önbellekleme nasıl yapılır?';
      if(isset($_SESSION['Tarayıcı önbellekleme nasıl yapılır?']))
      {
      }
      else{
      ...
      $_SESSION['Tarayıcı önbellekleme nasıl yapılır?']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='tarayici-onbellekleme-nasil-yapilir.php'>
