<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Robotu Labirentten Çıkarma';
      if(isset($_SESSION['[ROBOTBASIC] Robotu Labirentten Çıkarma']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Robotu Labirentten Çıkarma']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--robotu-labirentten-cikarma.php'>
