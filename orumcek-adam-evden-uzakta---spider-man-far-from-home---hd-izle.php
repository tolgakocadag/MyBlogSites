<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='Örümcek Adam Evden Uzakta - Spider Man Far From Home - HD izle';
      if(isset($_SESSION['Örümcek Adam Evden Uzakta - Spider Man Far From Home - HD izle']))
      {
      }
      else{
      ...
      $_SESSION['Örümcek Adam Evden Uzakta - Spider Man Far From Home - HD izle']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='orumcek-adam-evden-uzakta---spider-man-far-from-home---hd-izle.php'>
