<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='SEO Meta Etiketleri Nedir ve Nasıl Kullanılır?';
      if(isset($_SESSION['SEO Meta Etiketleri Nedir ve Nasıl Kullanılır?']))
      {
      }
      else{
      ...
      $_SESSION['SEO Meta Etiketleri Nedir ve Nasıl Kullanılır?']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='seo-meta-etiketleri-nedir-ve-nasil-kullanilir.php'>
