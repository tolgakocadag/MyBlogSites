<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Dizi Oluşturma';
      if(isset($_SESSION['[ROBOTBASIC] Dizi Oluşturma']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Dizi Oluşturma']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--dizi-olusturma.php'>
