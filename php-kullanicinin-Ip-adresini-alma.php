  ...
  ?>
  <?php
      $title='PHP Kullanıcının IP Adresini Alma';
      if(isset($_SESSION['PHP Kullanıcının IP Adresini Alma']))
      {
      }
      else{
      ...
      $_SESSION['PHP Kullanıcının IP Adresini Alma']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='php-kullanicinin-Ip-adresini-alma.php'>
