  ...
  ?>
  <?php
      $title='PHP Mysqli silme (delete) işlemi';
      if(isset($_SESSION['PHP Mysqli silme (delete) işlemi']))
      {
      }
      else{
      ...
      $_SESSION['PHP Mysqli silme (delete) işlemi']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='php-mysqli-silme--delete--islemi.php'>
                              ...
                              if(isset($_POST['post_comment'])){
                                ...
                                $sql_add->execute();
                                $sql_add->close();
                                header('Location: php-mysqli-silme--delete--islemi.php');
                              }
                              ?>
                          </div>
                      </div>
