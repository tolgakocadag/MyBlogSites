<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='Game Of Thrones 8.Sezon 3.Bölüm';
      if(isset($_SESSION['Game Of Thrones 8.Sezon 3.Bölüm']))
      {
      }
      else{
      ...
      $_SESSION['Game Of Thrones 8.Sezon 3.Bölüm']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='game-of-thrones-8-sezon-3-bolum.php'>
