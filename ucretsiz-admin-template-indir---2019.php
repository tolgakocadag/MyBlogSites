<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='Ücretsiz Admin Template İndir - 2019 -';
      if(isset($_SESSION['Ücretsiz Admin Template İndir - 2019 -']))
      {
      }
      else{
      ...
      $_SESSION['Ücretsiz Admin Template İndir - 2019 -']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='ucretsiz-admin-template-indir---2019.php'>
