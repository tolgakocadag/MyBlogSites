<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Break ve Continue Kullanımı';
      if(isset($_SESSION['[ROBOTBASIC] Break ve Continue Kullanımı']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Break ve Continue Kullanımı']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--break-ve-continue-kullanimi.php'>
