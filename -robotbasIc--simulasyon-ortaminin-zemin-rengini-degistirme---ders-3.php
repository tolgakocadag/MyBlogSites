<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Simülasyon Ortamının Zemin Rengini Değiştirme - Ders 3';
      if(isset($_SESSION['[ROBOTBASIC] Simülasyon Ortamının Zemin Rengini Değiştirme - Ders 3']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Simülasyon Ortamının Zemin Rengini Değiştirme - Ders 3']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--simulasyon-ortaminin-zemin-rengini-degistirme---ders-3.php'>
