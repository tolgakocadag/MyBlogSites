<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Çizgi İzleyen Robot';
      if(isset($_SESSION['[ROBOTBASIC] Çizgi İzleyen Robot']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Çizgi İzleyen Robot']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--cizgi-izleyen-robot.php'>
