<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Repeat ve While Döngüsü Kullanımı';
      if(isset($_SESSION['[ROBOTBASIC] Repeat ve While Döngüsü Kullanımı']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Repeat ve While Döngüsü Kullanımı']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--repeat-ve-while-dongusu-kullanimi.php'>
