<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Robotun Önündeki Engelleri Algılama Sensörleri';
      if(isset($_SESSION['[ROBOTBASIC] Robotun Önündeki Engelleri Algılama Sensörleri']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Robotun Önündeki Engelleri Algılama Sensörleri']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--robotun-onundeki-engelleri-algilama-sensorleri.php'>
