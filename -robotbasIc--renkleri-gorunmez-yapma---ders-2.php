<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Renkleri Görünmez Yapma - Ders 2';
      if(isset($_SESSION['[ROBOTBASIC] Renkleri Görünmez Yapma - Ders 2']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Renkleri Görünmez Yapma - Ders 2']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--renkleri-gorunmez-yapma---ders-2.php'>
