<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Robota Çizgi Çizdirme';
      if(isset($_SESSION['[ROBOTBASIC] Robota Çizgi Çizdirme']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Robota Çizgi Çizdirme']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--robota-cizgi-cizdirme.php'>
