<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[CANLI] Haziran 2019 Seçim Sonuçları';
      if(isset($_SESSION['[CANLI] Haziran 2019 Seçim Sonuçları']))
      {
      }
      else{
      ...
      $_SESSION['[CANLI] Haziran 2019 Seçim Sonuçları']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-canlI--haziran-2019-secim-sonuclari.php'>
