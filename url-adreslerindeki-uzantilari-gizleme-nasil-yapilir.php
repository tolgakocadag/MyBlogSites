<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='Url Adreslerindeki Uzantıları Gizleme Nasıl Yapılır?';
      if(isset($_SESSION['Url Adreslerindeki Uzantıları Gizleme Nasıl Yapılır?']))
      {
      }
      else{
      ...
      $_SESSION['Url Adreslerindeki Uzantıları Gizleme Nasıl Yapılır?']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='url-adreslerindeki-uzantilari-gizleme-nasil-yapilir.php'>
