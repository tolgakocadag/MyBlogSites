<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Robotun Yönünü ve Robotun X,Y Pozisyonunu Bulma';
      if(isset($_SESSION['[ROBOTBASIC] Robotun Yönünü ve Robotun X,Y Pozisyonunu Bulma']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Robotun Yönünü ve Robotun X,Y Pozisyonunu Bulma']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--robotun-yonunu-ve-robotun-x-y-pozisyonunu-bulma.php'>
