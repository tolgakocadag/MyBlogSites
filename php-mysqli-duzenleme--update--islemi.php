  ...
  ?>
  <?php
      $title='PHP Mysqli düzenleme (update) işlemi';
      if(isset($_SESSION['PHP Mysqli düzenleme (update) işlemi']))
      {
      }
      else{
      ...
      $_SESSION['PHP Mysqli düzenleme (update) işlemi']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='php-mysqli-duzenleme--update--islemi.php'>
                              ...
                              if(isset($_POST['post_comment'])){
                                ...
                                $sql_add->execute();
                                $sql_add->close();
                                header('Location: php-mysqli-duzenleme--update--islemi.php');
                              }
                              ?>
                          </div>
                      </div>
