<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='Game Of Thrones 8.Sezon 4.Bölüm Full izle';
      if(isset($_SESSION['Game Of Thrones 8.Sezon 4.Bölüm Full izle']))
      {
      }
      else{
      ...
      $_SESSION['Game Of Thrones 8.Sezon 4.Bölüm Full izle']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='game-of-thrones-8-sezon-4-bolum-full-izle.php'>
