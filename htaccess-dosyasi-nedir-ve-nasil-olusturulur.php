<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='Htaccess Dosyası Nedir ve Nasıl Oluşturulur';
      if(isset($_SESSION['Htaccess Dosyası Nedir ve Nasıl Oluşturulur']))
      {
      }
      else{
      ...
      $_SESSION['Htaccess Dosyası Nedir ve Nasıl Oluşturulur']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='htaccess-dosyasi-nedir-ve-nasil-olusturulur.php'>
