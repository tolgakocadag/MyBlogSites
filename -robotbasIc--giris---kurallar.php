<?php session_start();ob_start(); ?>
  ...
  ?>
  <?php
      $title='[ROBOTBASIC] Giriş - Kurallar';
      if(isset($_SESSION['[ROBOTBASIC] Giriş - Kurallar']))
      {
      }
      else{
      ...
      $_SESSION['[ROBOTBASIC] Giriş - Kurallar']=GetIP();
                          ...
                          <div class='col-10 col-sm-11'>
                              <div class='single-post'>
                                  ...
                                  <div class='post-content'>
                                      ...
                                      <a href='-robotbasIc--giris---kurallar.php'>
